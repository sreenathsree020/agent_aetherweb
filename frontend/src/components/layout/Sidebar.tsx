...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-52 border-r border-[var(--border-subtle)] bg-[var(--bg-surface)] p-3 flex flex-col justify-between shrink-0 overflow-y-auto transition-colors duration-150 font-sans">
